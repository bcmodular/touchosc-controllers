...
| 7 | **CC 7** | — | VCO LFO DEPTH | — | `10 00 00 08` | 7-bit (signed¹) |
| 8 | **CC 8** | **CC 15** | VCO RING LEVEL | VCO RING SW | `10 00 08 07` / `10 00 08 0D` | 7-bit / bool |
...
|-----|----|----------|------------|-------|
| 1 | **CC 16** | DIST ON/OFF | `10 00 0E 00` | Toggle, bool |
| 2 | **CC 17** | DIST COLOR | `10 00 0E 07` | Toggle, bool |
| 3 | **CC 18** | — | — | spare |
| 4 | **CC 19** | — | — | spare |
| 5 | **CC 20** | — | — | spare |
| 6 | **CC 21** | PORTAMENTO MODE | `10 00 14 02` | Toggle: LEGATO(0) / ALWAYS(1) |
| 7 | **CC 22** | DIST TYPE ↑ | `10 00 0E 01` | Momentary — Lua increments type (0–24), wraps |
| 8 | **CC 23** | DIST TYPE ↓ | `10 00 0E 01` | Momentary — Lua decrements type, wraps |

### Row 1 — VCA + Distortion character

| Col | CC | Function | SysEx addr | Type |
|-----|----|----------|------------|------|
| 1 | **CC 24** | VCA ATTACK | `10 00 0C 00` | 7-bit |
| 2 | **CC 25** | VCA DECAY | `10 00 0C 01` | 7-bit |
| 3 | **CC 26** | VCA SUSTAIN | `10 00 0C 02` | 7-bit |
| 4 | **CC 27** | VCA RELEASE | `10 00 0C 03` | 7-bit |
| 5 | **CC 28** | VCA LFO DEPTH | `10 00 00 0A` | 7-bit (signed¹) |
| 6 | **CC 29** | DIST DRIVE | `10 00 0E 02` | 7-bit (0–120) |
| 7 | **CC 30** | DIST BOTTOM | `10 00 0E 03` | 7-bit (0=−50, 50=0, 100=+50) |
| 8 | **CC 31** | DIST TONE | `10 00 0E 04` | 7-bit (0=−50, 50=0, 100=+50) |

### Row 2 — VCF + mix levels

| Col | CC | Function | SysEx addr | Type |
|-----|----|----------|------------|------|
| 1 | **CC 32** | VCF ATTACK | `10 00 0A 06` | 7-bit |
| 2 | **CC 33** | VCF DECAY | `10 00 0A 07` | 7-bit |
| 3 | **CC 34** | VCF SUSTAIN | `10 00 0A 08` | 7-bit |
| 4 | **CC 35** | VCF RELEASE | `10 00 0A 09` | 7-bit |
| 5 | **CC 36** | VCF CUTOFF | `10 00 0A 00/01` | **16-bit** (0–255) |
| 6 | **CC 37** | VCF RESONANCE | `10 00 0A 02/03` | **16-bit** (0–255) |
| 7 | **CC 38** | ACCENT LEVEL | `10 00 14 0E/0F` | **16-bit** (0–255) |
| 8 | **CC 39** | DIST EFFECT LEVEL | `10 00 0E 05` | 7-bit (0–100) |

### Row 3 — VCF modulation + oscillator levels

| Col | CC | Function | SysEx addr | Type | Notes |
|-----|----|----------|------------|------|-------|
| 1 | **CC 40** | VCO SAW LEVEL² | `10 00 08 00` | 7-bit | See note² |
| 2 | **CC 41** | VCO SQR LEVEL² | `10 00 08 01` | 7-bit | See note² |
| 3 | **CC 42** | VCO RING LEVEL² | `10 00 08 07` | 7-bit | See note² |
| 4 | **CC 43** | — | — | — | spare — TBD³ |
| 5 | **CC 44** | VCF ENV DEPTH | `10 00 0A 04/05` | **16-bit** (0–255) | Envelope → filter mod |
| 6 | **CC 45** | VCF KEY FOLLOW | `10 00 0A 0A` | 7-bit | |
| 7 | **CC 46** | VCF LFO DEPTH | `10 00 00 09` | 7-bit (signed¹) | |
| 8 | **CC 47** | DIST DRY LEVEL | `10 00 0E 06` | 7-bit (0–100) | |
